...
PING_IDENTITY_DEVOPS_USER=${PING_IDENTITY_DEVOPS_USER:-wesleymccollam@pingidentity.com}
PING_IDENTITY_DEVOPS_KEY=${PING_IDENTITY_DEVOPS_KEY:-04fabda2-7968-3b82-3b45-7faa1e76724c}
